...
def check_acc_arguments(method, nctype):
    myDictDefault = {
        'DAC': {'DNA': ['Rise', 'Roll', 'Shift', 'Slide', 'Tilt', 'Twist'], 'RNA': []},
        'DCC': {'DNA': ['Rise', 'Roll', 'Shift', 'Slide', 'Tilt', 'Twist'], 'RNA': []},
        'DACC': {'DNA': ['Rise', 'Roll', 'Shift', 'Slide', 'Tilt', 'Twist'], 'RNA': []},
    ...
    myDataFile = {
        'DAC': {'DNA': 'didnaPhyche.data', 'RNA': ''},
        'DCC': {'DNA': 'didnaPhyche.data', 'RNA': ''},
        'DACC': {'DNA': 'didnaPhyche.data', 'RNA': ''},
